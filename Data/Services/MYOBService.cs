...
namespace CarrotSystem.Services
{
    ...
    {
        void SyncMYOBtoDB(string dataType);
        string ExportToMYOB(string type, string exportDate, string userName);
        void ExportToDBbyLines(string type, string exportData, string exportDate, string userBy);
        int GetExportCount(string type, string exportDate);
        void ClearRecords(string type, string exportDate);
    }
    ...
    public class MYOBService : IMYOBService
    {
        ...
        private readonly string myobLibraryPath = "\\Live Files\\Live_TCC.myox";

        public MYOBService(IEventWriter logger, IContextService context, IAPIService api)
        {
            _logger = logger;
            _context = context;
            _api = api;
        ...
        public string ExportToMYOB(string type, string exportDate, string userName)
        {
        ...
        public void SyncMYOBtoDB (string dataType)
        {
            ...
            {
                SyncMYOBtoDB("Item");
                SyncMYOBtoDB("Customer");
                SyncMYOBtoDB("Supplier");
                SyncMYOBtoDB("Account");
                SyncMYOBtoDB("Job");
                SyncMYOBtoDB("Taxcode");
            }
